...
export const insights: Insight[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Personnel Security needs to coordinate with other groups about PIV cards, physical access, and system access, and must communicate with applicants and employees and contractors as well as Human Resources, ER/LR, CORs, DCSA, ODNI, agency management, and others.",
      "Essentially, Personnel Security offices need to continually be aware of and track every relevant fact about every worker based on national suitability and clearance standards. They are very busy, and our hats are off to them!",
      "Our promise is to keep making ABIS better and better to make the lives of personnel security workers easier.",
    ],
  },
  {
    ...
    content: [
      ...
      "Trusted Workforce will create more work for agencies, but an enterprise approach with significant automation can make it a net positive in terms of both effectiveness and time/$$ spent.",
    ],
  },
  {
